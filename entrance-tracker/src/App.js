...
const locationsList = {
  ...
  connectors: [
    ...
    { name: 'Kakariko House Right', checked: false },
    { name: 'Kakariko House Left', checked: false },
    ...
    { name: 'Race Game Right', checked: false },
    { name: 'Race Game Left', checked: false },
    { name: 'Spectacle Cave Top', checked: false },
    { name: 'Spectacle Cave Bottom', checked: false },
    { name: 'Spectacle Cave Middle', checked: false },
